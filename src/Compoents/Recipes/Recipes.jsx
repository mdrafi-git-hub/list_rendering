  ...
  Recipes.forEach(Recipes => {
    recipeCards.push(
      <div key={Recipes.id} className="recipe-card">
        ...
        <p><strong>Meal:</strong>{Recipes.mealType}</p>
        {/* <p><strong>Difficulty:</strong> {Recipes.difficulty}</p>
        <p><strong>Prep Time:</strong> {Recipes.prepTimeMinutes} minutes</p>
        <p><strong>Cook Time:</strong> {Recipes.cookTimeMinutes} minutes</p>
        <p><strong>Servings:</strong> {Recipes.servings}</p>
        <p><strong>Calories per Serving:</strong> {Recipes.caloriesPerServing}</p>
        <p><strong>Rating:</strong> {Recipes.rating} ({Recipes.reviewCount} reviews)</p> */}
